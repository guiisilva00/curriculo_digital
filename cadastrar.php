...
<main>
    <section class="conteiner-app conteiner-formulario">
        ...
        <p class="descricao-pagina">Preencha os campos abaixo para criar seu currículo digital.</p>
        ...
        <form action="salvar.php" method="POST">
            ...
            <fieldset>
                ...
                <div class="grade-formulario">
                    ...
                    <div class="campo-formulario largura-total">
                        ...
                        <textarea name="resumo" rows="5" placeholder="Resuma suas principais qualidades e competências..."></textarea>
                    </div>
                    <div class="campo-formulario largura-total">
                        <label>Objetivo Profissional</label>
                        <textarea name="objetivo" rows="4" placeholder="Descreva seus objetivos profissionais..."></textarea>
                    </div>
                    <div class="campo-formulario">
            ...
            <fieldset>
                ...
                <div class="grade-formulario">
                    ...
                    <div class="campo-formulario">
                        ...
                        <input type="text" name="projeto_tecnologias" placeholder="ex: PHP, MySQL, React">
                    </div>
                    <div class="campo-formulario">
                    ...
                    <div class="campo-formulario largura-total">
                        <label>Descrição</label>
                        <textarea name="projeto_descricao" rows="4" placeholder="Descreva o projeto e suas contribuições..."></textarea>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="grupo-botoes" style="justify-content: flex-start; margin-top: 20px;">
                ...
                <a href="index.php" class="botao botao-secundario" style="padding: 15px 30px; border-radius: 8px; text-decoration: none; color: white;">Cancelar</a>
            </div>
        </form>
    </section>
</main>
